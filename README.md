...
![AI Persona Setup](link-to-another-screenshot.png)
...
- See [docs/CONFIG.md](docs/CONFIG.md) for detailed setup instructions
...
Created by [@Larriemoses](https://github.com/Larriemoses).
...
Let me know if you want sections for badges, deployment, FAQs, or more detailed setup instructions!lowMeld
